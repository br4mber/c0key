...
const base64 = __webpack_require__(766)
const ieee754 = __webpack_require__(333)
...
__webpack_require__.d(__webpack_exports__, {
  "SHARE_SERIALIZATION_MODULE_NAME": () => (/* reexport */ SHARE_SERIALIZATION_MODULE_NAME),
  "ShareSerializationError": () => (/* reexport */ errors),
  "ShareSerializationModule": () => (/* reexport */ src_ShareSerializationModule),
  "default": () => (/* reexport */ src_ShareSerializationModule)
});
...
var ShareSerializationError = /*#__PURE__*/function (_TkeyError) {
  inherits_default()(ShareSerializationError, _TkeyError);
  var _super = _createSuper(ShareSerializationError);
  function ShareSerializationError(code, message) {
    var _this;
    classCallCheck_default()(this, ShareSerializationError);
  ...
  createClass_default()(ShareSerializationError, null, [{
    key: "fromCode",
    value: function fromCode(code) {
      var extraMessage = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "";
      return new ShareSerializationError(code, "".concat(ShareSerializationError.messages[code]).concat(extraMessage));
    }
  }, {
    key: "default",
    value: function _default() {
      var extraMessage = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
      return new ShareSerializationError(7000, "".concat(ShareSerializationError.messages[7000]).concat(extraMessage));
    }

    // Custom methods
  }, {
    key: "typeNotSupported",
    value: function typeNotSupported() {
      var extraMessage = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
      return ShareSerializationError.fromCode(7010, extraMessage);
    }
  }, {
    key: "invalidEntropy",
    value: function invalidEntropy() {
      var extraMessage = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
      return ShareSerializationError.fromCode(7011, extraMessage);
    }
  }, {
    key: "invalidChecksum",
    value: function invalidChecksum() {
      var extraMessage = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
      return ShareSerializationError.fromCode(7012, extraMessage);
    }
  }, {
    key: "invalidMnemonic",
    value: function invalidMnemonic() {
      var extraMessage = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
      return ShareSerializationError.fromCode(7013, extraMessage);
    }
  }]);
  return ShareSerializationError;
}(common_types_namespaceObject.TkeyError);
defineProperty_default()(ShareSerializationError, "messages", {
  7000: "Custom",
  // Misc
...
/* harmony default export */ const errors = (ShareSerializationError);
...
;// CONCATENATED MODULE: ./src/english.ts
...
/* provided dependency */ var Buffer = __webpack_require__(834)["lW"];
...
function deriveChecksumBits(entropyBuffer) {
  ...
  var CS = ENT / 32;
  var hash = external_create_hash_default()("sha256").update(entropyBuffer).digest();
...
function entropyToMnemonic(entropy, english) {
  ...
  var entropyBits = bytesToBinary(Array.from(newEntropy));
  var checksumBits = deriveChecksumBits(newEntropy);
...
function mnemonicToEntropy(mnemonic, english) {
  ...
  var bits = words.map(function (word) {
    var index = english.indexOf(word);
    if (index === -1) {
      throw errors.invalidMnemonic();
    }
  ...
  if (newChecksum !== checksumBits) {
    throw errors.invalidChecksum();
  }
  return entropy.toString("hex");
}
;// CONCATENATED MODULE: ./src/ShareSerializationModule.ts
...
var ShareSerializationModule = /*#__PURE__*/function () {
  function ShareSerializationModule() {
    classCallCheck_default()(this, ShareSerializationModule);
  ...
  createClass_default()(ShareSerializationModule, [{
    ...
    key: "serialize",
    value: function () {
      var _serialize = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee2(share, type) {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                return _context2.abrupt("return", ShareSerializationModule.serializeMnemonic(share));
              case 2:
    ...
    key: "deserialize",
    value: function () {
      var _deserialize = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee3(serializedShare, type) {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                return _context3.abrupt("return", ShareSerializationModule.deserializeMnemonic(serializedShare));
              case 2:
                throw errors.typeNotSupported();
              case 3:
              case "end":
    ...
    key: "serializeMnemonic",
    value: function serializeMnemonic(share) {
      return entropyToMnemonic(share.toString("hex").padStart(64, "0"), english);
    }
  }, {
    key: "deserializeMnemonic",
    value: function deserializeMnemonic(share) {
      return new (external_bn_js_default())(mnemonicToEntropy(share, english), "hex");
    }
  }]);
  return ShareSerializationModule;
}();
/* harmony default export */ const src_ShareSerializationModule = (ShareSerializationModule);
...
/******/ })()
;
//# sourceMappingURL=shareSerialization-bundled.cjs.js.map