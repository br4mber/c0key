...
import { TkeyError, ShareStore, getPubKeyPoint, getPubKeyECC, encrypt, decrypt, toPrivKeyECC } from '@tkey/common-types';
...
var ShareTransferError = /*#__PURE__*/function (_TkeyError) {
  ...
  _createClass(ShareTransferError, null, [{
    key: "fromCode",
...
_defineProperty(ShareTransferError, "messages", {
  8000: "Custom",
  // Misc
...
var ShareRequest = /*#__PURE__*/_createClass(function ShareRequest(_ref) {
  ...
  _defineProperty(this, "encPubKey", void 0);
  _defineProperty(this, "encShareInTransit", void 0);
  _defineProperty(this, "availableShareIndexes", void 0);
  _defineProperty(this, "userAgent", void 0);
  _defineProperty(this, "customInfo", void 0);
  _defineProperty(this, "userIp", void 0);
...
var ShareTransferStorePointer = /*#__PURE__*/_createClass(function ShareTransferStorePointer(_ref) {
  var pointer = _ref.pointer;
  _classCallCheck(this, ShareTransferStorePointer);
...
function _getClientIp() {
  _getClientIp = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return promiseTimeout(10000, fetch("https://icanhazip.com", {}).then(function (response) {
              if (response.ok) {
...
var ShareTransferModule = /*#__PURE__*/function () {
  function ShareTransferModule() {
    _classCallCheck(this, ShareTransferModule);
    _defineProperty(this, "moduleName", void 0);
    _defineProperty(this, "tbSDK", void 0);
    _defineProperty(this, "currentEncKey", void 0);
    _defineProperty(this, "requestStatusCheckId", void 0);
    _defineProperty(this, "requestStatusCheckInterval", void 0);
    this.moduleName = SHARE_TRANSFER_MODULE_NAME;
    this.requestStatusCheckInterval = 1000;
  }
  _createClass(ShareTransferModule, [{
              ...
              case 0:
                ...
                if (!rawShareTransferStorePointer) {
                  shareTransferStorePointer = {
                    pointer: new BN(generatePrivate())
                  };
    ...
    key: "requestNewShare",
    value: function () {
      var _requestNewShare = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3(userAgent, availableShareIndexes, callback) {
        var _this = this;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                throw ShareTransferError.requestExists("".concat(this.currentEncKey.toString("hex")));
              case 2:
              ...
              case 5:
                ...
                encPubKeyX = getPubKeyPoint(this.currentEncKey).x.toString("hex");
              ...
              case 13:
                // watcher
                if (callback) {
                  this.requestStatusCheckId = Number(setInterval( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2() {
                      ...
                      while (1) {
                        switch (_context2.prev = _context2.next) {
                          ...
                          case 3:
                            ...
                            throw ShareTransferError.missingEncryptionKey();
                          case 6:
                            ...
                            _context2.next = 9;
                            return decrypt(toPrivKeyECC(_this.currentEncKey), latestShareTransferStore[encPubKeyX].encShareInTransit);
                          case 9:
                            shareStoreBuf = _context2.sent;
                            receivedShare = ShareStore.fromJSON(JSON.parse(shareStoreBuf.toString()));
                            _context2.next = 13;
    ...
    value: function () {
      var _addCustomInfoToShareRequest = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4(encPubKeyX, customInfo) {
    ...
    key: "lookForRequests",
    value: function () {
      var _lookForRequests = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee5() {
        var shareTransferStore;
    ...
    key: "approveRequest",
    value: function () {
      var _approveRequest = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee6(encPubKeyX, shareStore) {
            ...
            switch (_context6.prev = _context6.next) {
              ...
              case 5:
                if (shareStore) {
                  ...
                  store = new ShareRequest(shareTransferStore[encPubKeyX]);
                ...
                shareRequest = new ShareRequest(shareTransferStore[encPubKeyX]);
                _context6.next = 9;
                return encrypt(shareRequest.encPubKey, bufferedShare);
              case 9:
    ...
    value: function () {
      var _approveRequestWithShareIndex = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee7(encPubKeyX, shareIndex) {
        var deviceShare;
    ...
    value: function () {
      var _getShareTransferStore = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee8() {
        ...
        return _regeneratorRuntime.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                metadata = this.tbSDK.getMetadata();
                shareTransferStorePointer = new ShareTransferStorePointer(metadata.getGeneralStoreDomain(this.moduleName));
    ...
    value: function () {
      var _setShareTransferStore = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee9(shareTransferStore) {
        var metadata, shareTransferStorePointer, storageLayer;
    ...
    value: function () {
      var _startRequestStatusCheck = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee11(encPubKeyX, deleteRequestAfterCompletion) {
        var _this2 = this;
            ...
            switch (_context11.prev = _context11.next) {
              case 0:
                return _context11.abrupt("return", new Promise(function (resolve, reject) {
                  _this2.requestStatusCheckId = Number(setInterval( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee10() {
                    var latestShareTransferStore, shareStoreBuf, receivedShare;
                      ...
                      while (1) {
                        switch (_context10.prev = _context10.next) {
                          ...
                          case 11:
                            ...
                            _context10.next = 14;
                            return decrypt(toPrivKeyECC(_this2.currentEncKey), latestShareTransferStore[encPubKeyX].encShareInTransit);
                          case 14:
    ...
    value: function () {
      var _cancelRequestStatusCheck = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee12() {
    ...
    value: function () {
      var _deleteShareTransferStore = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee13(encPubKey) {
    ...
    value: function () {
      var _resetShareTransferStore = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee14() {
...
export { SHARE_TRANSFER_MODULE_NAME, ShareRequest, ShareTransferError, ShareTransferModule, ShareTransferStorePointer, ShareTransferModule as default };
//# sourceMappingURL=shareTransfer.esm.js.map
